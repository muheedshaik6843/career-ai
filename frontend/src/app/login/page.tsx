...
import { Sparkles, User, ArrowRight, AlertCircle, Loader2, Mail, Lock, Eye, EyeOff, Chrome, Github } from "lucide-react";
...
export default function LoginPage() {
  ...
  const onSubmitEmail = async (data: EmailLoginFormValues) => {
    setIsLoading(true);
    setErrorMessage(null);
    try {
